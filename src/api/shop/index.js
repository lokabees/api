...
router.post(
    ...
    [
        ...
        body('address.country').exists().isString().trim().escape(),
        body('address.city').exists().isString().trim().escape(),
        body('address.postcode').exists().isString().trim().escape(),
        body('address.street').exists().isString().trim().escape(),
        body('address.number').exists().isString().trim().escape(),
        body('address.optional').optional().isString().trim().escape(),
        body('address.locality').exists().isString().trim().escape(),
        body('address.geometry.type').exists().isString().trim().escape().equals('Point'),
...
router.put('/:id',
    [
        ...
        body('address.postcode').optional().isString().trim().escape(),
        body('address.street').optional().isString().trim().escape(),
        body('address.number').optional().isString().trim().escape(),
        body('address.optional').optional().isString().trim().escape(),
        body('address.locality').optional().isString().trim().escape(),
        body('address.geometry.type').optional().isString().trim().escape().equals('Point'),
